...
STATE detect_fire() {
    ...
    if (!scan_complete) {
        ...
        float current_gyro = GYRO_reading();   // 0–360 absolute heading
        ...
        if (fire_visible && longAvg > peak_long_value) {
            ...
            peak_angle      = current_gyro;   // record heading of strongest reading
        }
